...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="./config/llava_reid.yml", help="path to config file", type=str
    )
    ...
    model = make_model(cfg, modelname="llava_vit", num_class=num_classes, num_class_domain_wise=num_pids)
