...
import os
import random
from model.backbones.models_mamba import VisionMamba, vim_small_patch16_stride8_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2
from model.backbones.vit_pytorch import SelfEnsembleViT, TransReID, deit_tiny_patch16_224_TransReID, resize_pos_embed, vit_base_patch32_224_TransReID, vit_large_patch16_224_TransReID
import torch
...
class build_vit(nn.Module):
    def __init__(self, num_classes, cfg, factory, num_cls_dom_wise=None):
        ...
        self.base = factory[cfg.MODEL.TRANSFORMER_TYPE]\
            ...
            stem_conv=True if cfg.MODEL.STEM_CONV else False)
...
class build_SEViT(nn.Module):
    def __init__(self, num_classes, cfg, factory, num_cls_dom_wise=None, num_cls_tokens=2):
        ...
        self.base = SelfEnsembleViT(stride_size=cfg.MODEL.STRIDE_SIZE, drop_path_rate=0.1)
