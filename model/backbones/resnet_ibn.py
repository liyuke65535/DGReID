...
model_urls = {
    ...
    'resnet50_ibn_a': '/home/nihao/data/checkpoints/resnet50_ibn_a-d9d0bb7b.pth',
    'resnet101_ibn_a': '/home/nihao/data/checkpoints/resnet101_ibn_a-59ea0ac6.pth',
    ...
    'resnet50_ibn_b': '/home/nihao/data/checkpoints/resnet50_ibn_b-9ca61e85.pth',
    'resnet101_ibn_b': '/home/nihao/data/checkpoints/resnet101_ibn_b-c55f6dba.pth',
}
...
def resnet50_ibn_a(pretrained=False, **kwargs):
    ...
    model = ResNet_IBN(block=Bottleneck_IBN,
                       ...
                       **kwargs)
    if pretrained:
        model.load_state_dict(torch.load(model_urls['resnet50_ibn_a']), strict=False)
    return model
...
def resnet50_ibn_b(pretrained=False, **kwargs):
    ...
    model = ResNet_IBN(block=Bottleneck_IBN,
                       ...
                       **kwargs)
    if pretrained:
        model.load_state_dict(torch.load(model_urls['resnet50_ibn_b']), strict=False)
    return model
