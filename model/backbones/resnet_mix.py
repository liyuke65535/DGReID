...
from model.backbones.mix_style_algos.domainqueue import DomainQueue, DomainQueue_2d
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.downsample = downsample
        self.stride = stride
        # self.instanceNorm = nn.InstanceNorm2d(planes, affine=True) ### add for test
