...
class DomainQueue(nn.Module):
    ...
    def __init__(self, num_features, num_domains, p=0.5, alpha=0.1, eps=1e-6, mix='random', capacity=1000):
        """
        Args:
        ...
        self.register_buffer('sig_queue', torch.zeros(num_domains, capacity, num_features))
    ...
    def forward(self, x, domain=None):
        ...
        # #### mixstyle like
        # mu_ = mu*lmda + mu_ * (1-lmda)
        # sig_ = sig*lmda + sig_ * (1-lmda)
