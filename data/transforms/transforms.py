...
# For self-supervise.
# Default: [90, 180, 270] degrees.
# We don't change the shape of the input, 
# which means an image of 256*128*3 resolution 
# turns into 128*256*3 through 90 degree rotation.
# Remember to put random rotation at the bottom of your transforms
# to avoid shape mismatch problems.
# ATTENTION!!!
...
if __name__ == '__main__':
    ...
    out = rand_rotate(prob=1.)(img)
    Image.Image.save(out,"/home/nihao/liyuke/DGReID/rotate_test.jpg")
