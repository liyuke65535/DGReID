from processor.vit_processor_with_amp_only_cls import vit_only_cls_do_train_with_amp
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="./config/reid.only_cls.yml", help="path to config file", type=str
    )
    ...
    vit_only_cls_do_train_with_amp(
        cfg,
        model,
        center_criterion,
        train_loader,
